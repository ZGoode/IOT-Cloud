...
String header = "<!DOCTYPE html>"
                ...
                "<a href='Configure' class='w3-bar-item w3-button w3-hide-small'><i class='fa fa-th'></i> CONFIGURE</a>"
...
String controlPage = "<!-- First Parallax Image with Logo Text -->"
                     ...
                     "<p><a href='/RainbowSky' class='w3-bar-item w3-button w3-hide-small'><i class='fa fa-star-o'></i> RAINBOW SKY</a>"
...
String configurePage = "<div class='bgimg w3-display-container w3-opacity-min' id='home'>"
                       ...
                       "<p><label>City Code (get from <a href='https://openweathermap.org/find?q=' target='_BLANK'>here</a>)</label><input class='w3-input w3-border w3-margin-bottom' type='text' name='city1' value='%CITY1%' onkeypress='return isNumberKey(event)'></p>"
